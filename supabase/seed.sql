...
insert into blog_posts (title, slug, excerpt, content, author, tags, is_published, published_at) values
  ('Why Destination Weddings Feel Different', 'why-destination-weddings-feel-different', 'A destination wedding isn''t just a change of venue — it''s a different way to gather the people you love.', E'A destination wedding asks guests to trade commutes for sunsets, and the celebration stretches into a real narrative arc — welcome drinks on arrival, rituals at dawn, a dance floor that feels earned rather than rushed.\n\nThe logistics are real: travel windows, climate, local permits. But the payoff is clarity. You design fewer, richer moments, and the place itself does half the storytelling — a palace courtyard, a cliff-edge lawn, a backwater deck. Treat the destination as a creative brief, not a backdrop, and the weekend writes itself.', 'Elysian Editorial', array['destination', 'planning', 'editorial'], true, now() - interval '14 days'),
  ('Udaipur Palace Weddings: Light and Shadow', 'udaipur-palace-weddings-light-and-shadow', 'Inside the palatial venues of Udaipur — where every corridor tells a story and every sunset is earned.', E'Udaipur rewards planners who respect the sun. Midday ceremonies glare off pale stone; late afternoon brings Lake Pichola into its softest palette. We map processions and portraits around those beats so the photographer works with the light, not against it.\n\nPalace properties vary in scale — some host two hundred guests with ease, others shine when kept intimate. Shortlist venues where flow feels natural: baraat entries that do not bottleneck, and elderly guests who never face impossible stairs without graceful alternatives. The city''s romance is old, but production values are modern.', 'Elysian Editorial', array['udaipur', 'venue', 'luxury'], true, now() - interval '10 days'),
  ('Budgeting Without the Spreadsheet Anxiety', 'budgeting-without-the-spreadsheet-anxiety', 'Your budget is a creative tool, not a cage. Here''s how to approach wedding finances with clarity.', E'A wedding budget is a creative tool, not a cage. The number on the top line matters less than what you are willing to expand for — atmosphere, hospitality, photography, music — and where you can hold the line gracefully.\n\nThe planning surface should let you see target allocations, real quotes, and final spend in one frame. When those three numbers move together, decisions stop feeling like betrayals of taste and start feeling like editing — quieter cuts, sharper choices, a celebration that reads as deliberate.', 'Elysian Editorial', array['budget', 'planning', 'guide'], true, now() - interval '7 days'),
  ('The Art of the Guest Experience', 'the-art-of-the-guest-experience', 'Your wedding guests are traveling for you. Here''s how to make every moment of their journey intentional.', E'Your guests are travelling for you. The drive from the airport, the welcome dossier in the room, the first cocktail in their hand — each one is a chance to set tone before the ceremony has begun.\n\nDesign the weekend like a hosted dinner, not a logistics document. Maps that read like editorial. Welcome bites that match the cuisine of the place. A morning option for the people who want stillness, an after-party for the ones who don''t. The wedding is the centrepiece; the experience around it is what people actually remember.', 'Elysian Editorial', array['guests', 'planning', 'experience'], true, now() - interval '5 days'),
  ('Monsoon Weddings: Embracing the Rain', 'monsoon-weddings-embracing-the-rain', 'Rain on your wedding day isn''t bad luck — it''s an atmosphere. Planning tips for monsoon celebrations.', E'Rain on a wedding day is not bad luck — it is a mood. Indian monsoon air is cinematic in a way no decor budget can buy: low cloud, soaked stone, lanterns reading twice as bright against grey.\n\nPlan for it instead of around it. Covered walkways between functions. A mandap design with built-in shelter. A rainwear moment — clear umbrellas, a bridal stole — that becomes part of the look. The most graceful monsoon weddings treat weather as a co-author, not an emergency.', 'Elysian Editorial', array['monsoon', 'planning', 'seasonal'], true, now() - interval '3 days'),
  ('Choosing Vendors Who Understand Your Vision', 'choosing-vendors-who-understand-your-vision', 'The right vendor doesn''t just deliver a service — they co-create your vision with you.', E'The right vendor doesn''t just deliver a service. They translate taste — they understand what you mean when you say "warmer, but not sweet," or "festive without feeling formal" — and they hold the line when scope tries to creep loud.\n\nLook for chemistry first, portfolio second, price third. A photographer whose galleries breathe. A floral designer who knows when to subtract. A caterer who can defend a single dish at a tasting. Vet for taste and composure; trust the rest will follow.', 'Elysian Editorial', array['vendors', 'planning', 'guide'], true, now() - interval '1 day');
