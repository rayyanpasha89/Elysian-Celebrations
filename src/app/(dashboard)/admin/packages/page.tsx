  ...
  if (loadError) {
    return (
      <DashboardLoadError
        eyebrow="Management"
        pageTitle="Packages"
        label="Package catalogue unavailable"
        title="We could not load planning tiers"
        description="No package counts or inactive states have been inferred from the failed request. Retry to reconnect to the catalogue."
