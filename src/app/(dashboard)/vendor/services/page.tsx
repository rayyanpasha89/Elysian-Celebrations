...
const seed: Service[] = [
  {
    ...
    description: "Two lead photographers, full-day coverage from prep through reception.",
    basePrice: 285000,
    unit: "per event",
    active: true,
  },
  {
    ...
    description: "Half-day editorial session at one location within city limits.",
    basePrice: 65000,
    unit: "per day",
    active: true,
  },
  {
    ...
    description: "40-spread lay-flat album, proofing included.",
    basePrice: 95000,
    unit: "per event",
    active: false,
  },
              ...
              <div className="flex flex-wrap items-start justify-between gap-4 border-b border-charcoal/8 pb-4">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <button
                    ...
                    onClick={() => toast.success("Service editor coming soon")}
                  >
                    Edit
                  </button>
                  <button
