...
const atlasScenes = [
  ...
  },
  {
    ...
    copy: "Couples choose real packages, catalogue rows, setups, counters, deliverables, and add-ons first. Custom requests stay separate so they can be quoted honestly.",
  ...
  },
  {
    ...
    copy: "Per-person food, venue cues, selected services, quote-only items, paid amounts, and due balances stay tied to the actual function they belong to.",
    coreTitle: "Budget gravity",
    metric: "Live sync",
    stat: "Plan ↔ budget",
    tone: "olive",
    details: ["Per-person", "Quotes", "Paid", "Variance"],
  ...
  },
  {
    ...
    copy: "The final layer exposes missing vendors, incomplete logistics, guest gaps, menu gaps, unquoted special requests, and run-of-show risk before the event moves forward.",
