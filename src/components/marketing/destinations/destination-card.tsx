...
export function DestinationCard({
  ...
  return (
    <motion.div
      ...
      className="group relative h-[62vh] min-h-[460px] w-[min(86vw,410px)] flex-shrink-0 cursor-pointer overflow-hidden border border-white/10 md:w-[410px]"
    >
      <motion.div
      ...
      <div className="absolute left-5 right-5 top-5 z-20 flex items-start justify-between gap-4">
        ...
        <span className="font-display text-4xl font-bold text-ivory/[0.08]">
      ...
      <div className="absolute bottom-0 left-0 right-0 z-20 p-6">
        ...
        <h3 className="font-display text-3xl font-bold text-ivory">{name}</h3>
