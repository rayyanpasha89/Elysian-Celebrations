...
/* ------------------------------------------------------------ deck fields */
const ORG = "TIPS Founder's Desk";
const COLLEGE = "Atria University, Bengaluru";
const MENTOR = "Padmini Raghavendra — Director & CEO";
const DURATION = "01 Apr 2025 – 30 Dec 2026";
...
async function main() {
  ...
  const file = path.join(OUT, "Elysian-Internship-Extended.pptx");
